...
ggplot() +
  geom_smooth(data = baysysluekercarb, 
              aes(x = t, y = p_co2insitu, color = "BaySys lueker Carb"),
              method = "lm", 
              se = FALSE,
              linewidth = 0.75) +
  geom_smooth(data = baysysluekersys, 
              aes(x = t_c, y = p_co2_out_matm, color = "BaySys lueker Sys"),
              method = "lm", 
              se = FALSE, 
              linewidth = 0.75) +
  geom_smooth(data = baysysmillero2010carb, 
              aes(x = t, y = p_co2insitu, color = "BaySys Miller 2010 Carb"),
              method = "lm",
              se = FALSE,
              linewidth = 0.75) +
  geom_smooth(data = baysysmillero2010sys, 
              aes(x = t_c, y = p_co2_out_matm, color = "BaySys Miller 2010 Sys"),
              method = "lm", 
              se = FALSE,
              linewidth = 0.75) +
  xlab("Temperature (c)") +
